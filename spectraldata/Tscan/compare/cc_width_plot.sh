...
plot "../Debye/plots/Jpsi_width_Debye.dat" u 1:3:4 notitle w filledcurves fs transparent solid 0.2 lc rgb '#e41a1c', \
     "../Debye/plots/psip_width_Debye.dat" u 1:3:4 notitle w filledcurves fs transparent solid 0.2 lc rgb '#377eb8', \
     "../AsReg/plots/Jpsi_width.dat" u 1:3:4 notitle w filledcurves lc rgb '#e41a1c', \
     "" u 1:2 title '\(J/\psi\)' w l lt 1 lw 6 lc rgb '#e41a1c', \
     "../AsReg/plots/psip_width.dat" u 1:3:4 notitle w filledcurves lc rgb '#377eb8', \
