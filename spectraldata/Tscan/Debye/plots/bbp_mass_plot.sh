...
plot "chib_Econt_Debye.dat" u 1:3:4 notitle w filledcurves lc rgb 'light-gray', \
     "" u 1:2 title '\(E_{cont}\)' w l lt 1 lw 2 lc rgb 'light-gray', \
     "chib1_mass_Debye.dat" u 1:3:4 notitle w filledcurves lc rgb '#e41a1c', \
     "" u 1:2 title '\(\chi_{b0}(1S)\)' w l lt 1 lw 4 lc rgb '#e41a1c', \
     "chib2_mass_Debye.dat" u 1:3:4 notitle w filledcurves lc rgb '#377eb8', \
     "" u 1:2 title '\(\chi_{b0}(2S)\)' w l lt 1 lw 4 lc rgb '#377eb8', \
     "chib3_mass_Debye.dat" u 1:2:3 notitle w filledcurves lc rgb '#ff7f00', \
     "" u 1:2 title '\(\chi_{b0}(3S)\)' w l lt 1 lw 4 lc rgb '#ff7f00'

EOF

latex "chib_mass.tex"
dvips -o "chib_mass.ps" "chib_mass.dvi"
rm *.dvi *.aux *.log
rm *.tex *.eps
ps2pdf -dEPSCrop "chib_mass.ps" "chib_mass.pdf"
rm "chib_mass.ps"
open "chib_mass.pdf"