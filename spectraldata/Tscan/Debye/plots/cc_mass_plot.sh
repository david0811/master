...
plot "cc_Econt_Debye.dat" u 1:3:4 notitle w filledcurves lc rgb 'light-gray', \
     "" u 1:2 title '\(E_{cont}\)' w l lt 1 lw 2 lc rgb 'light-gray', \
     "Jpsi_mass_Debye.dat" u 1:3:4 notitle w filledcurves lc rgb '#e41a1c', \
     "" u 1:2 title '\(J/\psi\)' w l lt 1 lw 4 lc rgb '#e41a1c', \
     "psip_mass_Debye.dat" u 1:3:4 notitle w filledcurves lc rgb '#377eb8', \
