...
plot "chib1_width_Debye.dat" u 1:3:4 notitle w filledcurves lc rgb '#e41a1c', \
     "" u 1:2 title '\(\chi_{b0}(1S)\)' w l lt 1 lw 4 lc rgb '#e41a1c', \
     "chib2_width_Debye.dat" u 1:3:4 notitle w filledcurves lc rgb '#377eb8', \
     "" u 1:2 title '\(\chi_{b0}(2S)\)' w l lt 1 lw 4 lc rgb '#377eb8', \
     "chib3_width_Debye.dat" u 1:2:3 notitle w filledcurves lc rgb '#ff7f00', \
