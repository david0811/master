...
set ylabel 'Area\(\;\left[\mathrm{GeV}\right]\)' offset -2,0
...
plot "Jpsi_area.dat" u 1:3:4 notitle w filledcurves lc rgb '#e41a1c', \
     "" u 1:2 title '\(J/\psi\)' w l lt 1 lw 4 lc rgb '#e41a1c', \
     "psip_area.dat" u 1:3:4 notitle w filledcurves lc rgb '#377eb8', \
