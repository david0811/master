...
set output "psip2psi_s_data.tex"
...
plot "psip2psi_s_NA50.dat" u 1:2:3:4 notitle w yerrorbars lt 7 lw 3 pointsize 2 lc rgb '#e41a1c', \
...
latex "psip2psi_s_data.tex"
dvips -o "psip2psi_s_data.ps" "psip2psi_s_data.dvi"
rm *.dvi *.aux *.log
rm *.tex *.eps
ps2pdf -dEPSCrop "psip2psi_s_data.ps" "psip2psi_s_data.pdf"
rm "psip2psi_s_data.ps"
open "psip2psi_s_data.pdf"
