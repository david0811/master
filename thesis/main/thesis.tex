...
\end{equation}
where \(b=11-\frac{2}{3}N_F\) and \(N_F\) is the number of flavours. The minus sign is of tremendous importance. It implies that for \(N_F\leq 16\) the QCD coupling constant decreases as the energy or momentum scale increases. This is perhaps more easily seen after integrating Eq.~\eqref{eq:betaQCD_oneloop} to give
\begin{equation}
