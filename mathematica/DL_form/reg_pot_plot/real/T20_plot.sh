...
plot "ReVT0.dat" using 1:2 notitle w l ls 2, \
     "ReVcT2000.dat" using 1:2 notitle w l ls 1,\
     "ReVsT2000.dat" using 1:2 notitle w l ls 3, \
     "ReVT2000.dat" using 1:2 notitle w l ls 4


EOF

latex "ReV_T2000.tex"
dvips -o "ReV_T2000.ps" "ReV_T2000.dvi"
rm *.dvi *.aux *.log
rm *.tex *.eps
ps2pdf -dEPSCrop "ReV_T2000.ps" "ReV_T2000.pdf"
rm "ReV_T2000.ps"
open "ReV_T2000.pdf"
