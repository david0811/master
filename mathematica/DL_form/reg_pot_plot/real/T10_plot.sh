...
plot "ReVT0.dat" using 1:2 notitle w l ls 2, \
     "ReVcT1000.dat" using 1:2 notitle w l ls 1,\
     "ReVsT1000.dat" using 1:2 notitle w l ls 3, \
     "ReVT1000.dat" using 1:2 notitle w l ls 4


EOF

latex "ReV_T1000.tex"
dvips -o "ReV_T1000.ps" "ReV_T1000.dvi"
rm *.dvi *.aux *.log
rm *.tex *.eps
ps2pdf -dEPSCrop "ReV_T1000.ps" "ReV_T1000.pdf"
rm "ReV_T1000.ps"
open "ReV_T1000.pdf"
