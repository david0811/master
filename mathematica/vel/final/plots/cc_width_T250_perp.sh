...
set output "cc_width_T250_perp.tex"
...
plot "../data/Jpsi_width_T250_perp.dat" u 1:3:4 notitle w filledcurves lc rgb '#4daf4a', \
...
latex "cc_width_T250_perp.tex"
dvips -o "cc_width_T250_perp.ps" "cc_width_T250_perp.dvi"
rm *.dvi *.aux *.log
rm *.tex *.eps
ps2pdf -dEPSCrop "cc_width_T250_perp.ps" "cc_width_T250_perp.pdf"
rm "cc_width_T250_perp.ps"
open "cc_width_T250_perp.pdf"
