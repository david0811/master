...
set output "cc_mass_T150_par.tex"
...
plot "../data/Jpsi_mass_T150_par.dat" u 1:3:4 notitle w filledcurves lc rgb '#4daf4a', \
     "" u 1:2 title '\(J/\psi\)' w l lt 1 lw 4 lc rgb '#4daf4a', \
     "../data/psip_mass_T150_par.dat" u 1:3:4 notitle w filledcurves lc rgb '#984ea3', \
...
latex "cc_mass_T150_par.tex"
dvips -o "cc_mass_T150_par.ps" "cc_mass_T150_par.dvi"
rm *.dvi *.aux *.log
rm *.tex *.eps
ps2pdf -dEPSCrop "cc_mass_T150_par.ps" "cc_mass_T150_par.pdf"
rm "cc_mass_T150_par.ps"
open "cc_mass_T150_par.pdf"
