...
set output "cc_mass_T250_par.tex"
...
set key at graph 0.3, graph 0.8

set style fill transparent solid 0.5 noborder

plot "../data/Jpsi_mass_T250_par.dat" u 1:3:4 notitle w filledcurves lc rgb '#4daf4a', \
...
latex "cc_mass_T250_par.tex"
dvips -o "cc_mass_T250_par.ps" "cc_mass_T250_par.dvi"
rm *.dvi *.aux *.log
rm *.tex *.eps
ps2pdf -dEPSCrop "cc_mass_T250_par.ps" "cc_mass_T250_par.pdf"
rm "cc_mass_T250_par.ps"
open "cc_mass_T250_par.pdf"
