...
set output "bb_mass_T250_par.tex"
...
plot "../data/Upsilon1_mass_T250_par.dat" u 1:3:4 notitle w filledcurves lc rgb '#e41a1c', \
     "" u 1:2 title '\(\Upsilon(1S)\)' w l lt 1 lw 4 lc rgb '#e41a1c', \
     "../data/Upsilon2_mass_T250_par.dat" u 1:3:4 notitle w filledcurves lc rgb '#377eb8', \
...
latex "bb_mass_T250_par.tex"
dvips -o "bb_mass_T250_par.ps" "bb_mass_T250_par.dvi"
rm *.dvi *.aux *.log
rm *.tex *.eps
ps2pdf -dEPSCrop "bb_mass_T250_par.ps" "bb_mass_T250_par.pdf"
rm "bb_mass_T250_par.ps"
open "bb_mass_T250_par.pdf"
