...
set output "bb_width_T250_par.tex"
...
plot "../data/Upsilon1_width_T250_par.dat" u 1:3:4 notitle w filledcurves lc rgb '#e41a1c', \
     "" u 1:2 title '\(\Upsilon(1S)\)' w l lt 1 lw 4 lc rgb '#e41a1c', \
     "../data/Upsilon2_width_T250_par.dat" u 1:3:4 notitle w filledcurves lc rgb '#377eb8', \
...
latex "bb_width_T250_par.tex"
dvips -o "bb_width_T250_par.ps" "bb_width_T250_par.dvi"
rm *.dvi *.aux *.log
rm *.tex *.eps
ps2pdf -dEPSCrop "bb_width_T250_par.ps" "bb_width_T250_par.pdf"
rm "bb_width_T250_par.ps"
open "bb_width_T250_par.pdf"
